 ...
 * 
 */
package com.dpaula.token.security.util;
...
public class SecurityContextUtil {
    ...
    public static void setSecurityContext(SignedJWT signedJWT) {
        try {
            ...
            if (username == null)
                throw new JOSEException("[FERNANDO] Nome de usuário ausente do JWT");
            ...
            log.error("[FERNANDO] Erro ao definir contexto de segurança", e);
